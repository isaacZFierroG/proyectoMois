    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mina', models.PositiveIntegerField(choices=[(1, 'HERMOSILLO'), (2, 'CANANEA')], verbose_name='Mina a la que es asignado el usuario')),
                ('zona', models.PositiveIntegerField(verbose_name='Zona de la mina a la que es asignado el usuario')),
